...
,p_required_patch=>wwv_flow_imp.id(56838373212740892045)
,p_dialog_chained=>'N'
,p_page_is_public_y_n=>'Y'
,p_protection_level=>'C'
,p_page_component_map=>'25'
,p_last_updated_by=>'OSKARAS.STARINSKAS@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20230408084905'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(56838554011045892944)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(56838554473306892944)
,p_name=>'P10061_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(56838554011045892944)
