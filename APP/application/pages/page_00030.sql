...
,p_last_upd_yyyymmddhh24miss=>'20230430133307'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73423176780526227746)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73423177398355227749)
...
'        IMAGE, ',
'        BADGE ',
'from ITEMS where upper(category) = ''LAPTOPS'''))
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(73423180635218227752)
,p_region_id=>wwv_flow_imp.id(73423177398355227749)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(24089960440160304735)
,p_card_id=>wwv_flow_imp.id(73423180635218227752)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(24089960551765304736)
,p_card_id=>wwv_flow_imp.id(73423180635218227752)
,p_action_type=>'BUTTON'
,p_position=>'PRIMARY'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73423177449195227749)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(73423177398355227749)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73423179449390227751)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(73423179917146227751)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(73423179449390227751)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73423177993235227750)
,p_name=>'P30_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(73423177449195227749)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73423178375746227750)
,p_name=>'P30_SUPPLIER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73423178784634227751)
,p_name=>'P30_MODEL'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(73423177449195227749)
