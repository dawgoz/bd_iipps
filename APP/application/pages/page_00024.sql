...
,p_last_upd_yyyymmddhh24miss=>'20230430132713'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70819149380821982983)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70819149955202982985)
...
'        IMAGE, ',
'        BADGE ',
'from ITEMS where upper(category) = ''PHONES'''))
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(70819153207208982991)
,p_region_id=>wwv_flow_imp.id(70819149955202982985)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(70428340652572477930)
,p_card_id=>wwv_flow_imp.id(70819153207208982991)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(70428341185546477935)
,p_card_id=>wwv_flow_imp.id(70819153207208982991)
,p_action_type=>'BUTTON'
,p_position=>'PRIMARY'
,p_display_sequence=>20
,p_label=>'Diagnostic Service'
,p_link_target_type=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70819150069364982985)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(70819149955202982985)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70819152091469982988)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(70819152561216982989)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(70819152091469982988)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70819150578729982986)
,p_name=>'P24_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(70819150069364982985)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70819150925074982987)
,p_name=>'P24_SUPPLIER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70819151319877982987)
,p_name=>'P24_MODEL'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(70819150069364982985)
