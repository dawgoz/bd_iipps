...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(56838267352961891990)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838267698417891990)
,p_plug_template_id=>wwv_flow_imp.id(56838267352961891990)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838267961285891991)
,p_plug_template_id=>wwv_flow_imp.id(56838267352961891990)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838268216441891991)
,p_plug_template_id=>wwv_flow_imp.id(56838267352961891990)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838268580214891991)
,p_plug_template_id=>wwv_flow_imp.id(56838267352961891990)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838268887501891991)
,p_plug_template_id=>wwv_flow_imp.id(56838267352961891990)
,p_name=>'Sub Regions'
