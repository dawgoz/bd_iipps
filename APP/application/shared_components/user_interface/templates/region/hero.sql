...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(56838239512870891979)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838239840748891979)
,p_plug_template_id=>wwv_flow_imp.id(56838239512870891979)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838240146120891979)
,p_plug_template_id=>wwv_flow_imp.id(56838239512870891979)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838240482732891979)
,p_plug_template_id=>wwv_flow_imp.id(56838239512870891979)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838240766876891979)
,p_plug_template_id=>wwv_flow_imp.id(56838239512870891979)
,p_name=>'Sub Regions'
