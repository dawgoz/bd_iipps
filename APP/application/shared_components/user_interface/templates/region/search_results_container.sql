...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(56838269820193891991)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838270138936891992)
,p_plug_template_id=>wwv_flow_imp.id(56838269820193891991)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838270474870891992)
,p_plug_template_id=>wwv_flow_imp.id(56838269820193891991)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838270791168891992)
,p_plug_template_id=>wwv_flow_imp.id(56838269820193891991)
,p_name=>'Sub Regions'
