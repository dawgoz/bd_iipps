...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(56838264894466891989)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2172973353684631033)
,p_plug_template_id=>wwv_flow_imp.id(56838264894466891989)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838265194789891990)
,p_plug_template_id=>wwv_flow_imp.id(56838264894466891989)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838265447209891990)
,p_plug_template_id=>wwv_flow_imp.id(56838264894466891989)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838265731299891990)
,p_plug_template_id=>wwv_flow_imp.id(56838264894466891989)
,p_name=>'Button Start'
