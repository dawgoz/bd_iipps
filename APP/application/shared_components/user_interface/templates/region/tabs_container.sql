...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(56838282356407891997)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838282618123891997)
,p_plug_template_id=>wwv_flow_imp.id(56838282356407891997)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838282976209891997)
,p_plug_template_id=>wwv_flow_imp.id(56838282356407891997)
,p_name=>'Tabs'
