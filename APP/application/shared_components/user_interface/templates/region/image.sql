...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(56838242787123891980)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838243066192891980)
,p_plug_template_id=>wwv_flow_imp.id(56838242787123891980)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838243334604891980)
,p_plug_template_id=>wwv_flow_imp.id(56838242787123891980)
,p_name=>'Sub Regions'
