...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(56838181295578891953)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838181514161891953)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838181802640891953)
,p_page_template_id=>wwv_flow_imp.id(56838181295578891953)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838182120812891953)
,p_page_template_id=>wwv_flow_imp.id(56838181295578891953)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838182434766891953)
,p_page_template_id=>wwv_flow_imp.id(56838181295578891953)
,p_name=>'Body Footer'
