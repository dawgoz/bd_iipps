...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(56838191248570891957)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838191523514891958)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838191823211891958)
,p_page_template_id=>wwv_flow_imp.id(56838191248570891957)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838192185478891958)
,p_page_template_id=>wwv_flow_imp.id(56838191248570891957)
