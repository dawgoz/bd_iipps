...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(56838170694133891946)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838170955072891947)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838171276397891947)
,p_page_template_id=>wwv_flow_imp.id(56838170694133891946)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838171580007891947)
,p_page_template_id=>wwv_flow_imp.id(56838170694133891946)
