...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(56838199866992891961)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838200159369891962)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838200454072891962)
,p_page_template_id=>wwv_flow_imp.id(56838199866992891961)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56838200716326891962)
,p_page_template_id=>wwv_flow_imp.id(56838199866992891961)
